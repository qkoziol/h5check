...
/* Function prototypes */
H5CHKDLL void  error_push(primary_err_t, secondary_err_t, const char *, ck_addr_t, int *);
H5CHKDLL ck_err_t error_clear(void);
H5CHKDLL void   error_print(FILE *, driver_t *);
H5CHKDLL int   found_error(void);
H5CHKDLL void  process_errors(ck_errmsg_t *errbuf);
