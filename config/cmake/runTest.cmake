...
MESSAGE (STATUS "COMMAND: ${TEST_PROGRAM} ${TEST_ARGS} ${TEST_FILE}")
...
IF (EXISTS ${TEST_FILE})
  ...
  EXECUTE_PROCESS (
      COMMAND ${TEST_PROGRAM} ${TEST_ARGS} ${TEST_FILE}
  ...
  ENDIF (TEST_REFERENCE)

  # everything went fine...
  MESSAGE ("Passed: The output of ${TEST_PROGRAM} matches ${TEST_REFERENCE}")
ELSE (EXISTS ${TEST_FILE})
  MESSAGE (FATAL_ERROR "COMMAND Result: ${TEST_PROGRAM} ${TEST_ARGS} ${TEST_FILE} SKIPPED")
  SET (TEST_RESULT 2)
